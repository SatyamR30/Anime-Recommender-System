...
class DataProcessor:
    ...
    def load_data(self,usecols):
        try:
            ...
            print(f"Error in {__file__} , line {inspect.currentframe().f_lineno} : Failed to load data\nReason: {e}")
    ...
    def filter_users(self,min_rating=400):
        try:
            ...
            print(f"Error in {__file__} , line {inspect.currentframe().f_lineno} : Failed to filter data\nReason: {e}")
